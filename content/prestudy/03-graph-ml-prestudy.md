# 3차시 예습 노트: Graph Machine Learning
...
## 노트 6. Message Passing / Neighborhood Aggregation
...
이번 예습 노트에서는 아래 항목을 깊게 다루지 않는다. 이름만 확인하고 수업 후 복습 또는 이후 차시에서 다룬다.
