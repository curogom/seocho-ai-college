...
- 전체 차시 인덱스: `/sessions`
- 개별 차시: `/sessions/01`, `/sessions/02`, `/sessions/03`, `/sessions/04`, `/sessions/06-1`, `/sessions/06-2`, `/sessions/07`
- 05차시는 휴강으로 `추후 보강` 슬롯으로 표시하고, 06차시는 `6-1`, `6-2` 하위 노트로 표시하며, 08~16차시는 `sessionSlots`에서 대기 슬롯으로 표시한다.
